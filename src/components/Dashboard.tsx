...
import { Battery, Zap, AlertTriangle, TrendingDown, Calendar, Timer, Filter, Activity, TrendingUp, Sparkles, Clock, CheckCircle, Download } from 'lucide-react';
...
export default function Dashboard({ mutations, lowThreshold, kwhTariff = 1444.7, activeTab = 'dashboard' }: DashboardProps) {
